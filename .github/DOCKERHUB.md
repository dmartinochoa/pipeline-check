...
A read-only scanner for **35 providers** (CI/CD and infrastructure),
mapped to **18 compliance standards**, with **1180+ checks** and
**111 autofixers**.
...
miss, and **54 attack chains** correlate findings into MITRE ATT&CK-mapped
kill chains.
