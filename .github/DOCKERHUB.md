...
A read-only scanner for **23 providers** (CI/CD and infrastructure),
mapped to **15 compliance standards**, with **840+ checks** and
**111 autofixers**.
...
miss, and **41 attack chains** correlate findings into MITRE ATT&CK-mapped
kill chains.
