...
A read-only scanner for **31 providers** (CI/CD and infrastructure),
mapped to **18 compliance standards**, with **1050+ checks** and
**111 autofixers**.
...
miss, and **48 attack chains** correlate findings into MITRE ATT&CK-mapped
kill chains.
