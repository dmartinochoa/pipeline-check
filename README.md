...
└── core/
    ...
    └── checks/
        ...
        ├── scm/rules/         # SCM-001 .. SCM-029 — repo governance via the platform REST API (GitHub full pack incl. Actions governance + environment protection + deploy-keys + webhook security + outside-collaborator audit + private-repo fork policy + ruleset enforcement; GitLab + Bitbucket universal subset)
