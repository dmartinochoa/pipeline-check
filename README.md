...
└── core/
    ...
    └── checks/
        ...
        ├── scm/rules/         # SCM-001 .. SCM-028 — repo governance via the platform REST API (GitHub full pack incl. Actions governance + environment protection + deploy-keys + webhook security + outside-collaborator audit + private-repo fork policy; GitLab + Bitbucket universal subset)
