...
└── core/
    ...
    └── checks/
        ...
        ├── scm/rules/         # SCM-001 .. SCM-026 — repo governance via the platform REST API (GitHub full pack incl. Actions governance + environment protection + deploy-keys + webhook security; GitLab + Bitbucket universal subset)
