...
└── core/
    ...
    └── checks/
        ...
        ├── scm/rules/         # SCM-001 .. SCM-025 — repo governance via the platform REST API (GitHub full pack incl. Actions governance + environment protection; GitLab + Bitbucket universal subset)
