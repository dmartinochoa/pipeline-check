...
└── core/
    ...
    └── checks/
        ...
        ├── scm_org/rules/     # ORG-001 .. ORG-002 — GitHub organization-wide governance via the REST API (org-wide 2FA requirement, default member repository permission); complements scm (one repo) with org-level posture
