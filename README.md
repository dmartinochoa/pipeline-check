...
| `--scm-platform` | | SCM platform for `--pipeline scm`: `github` (full 31-rule pack), `gitlab`, or `bitbucket` (each gets a 7-rule universal subset) |
