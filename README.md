...
| **GitHub Actions** | `.github/workflows/*.yml` | `--gha-path` | 112 checks · `GHA-001..073`, `GHA-086..121` + `TAINT-001..003`/`009` · SHA pinning, script injection, OIDC trusted-publishing abuse, agentic-CLI / IaC-apply RCE, prompt injection, `trust_remote_code` model loads, unpinned model refs, compromised-action and npm-worm IOCs, `$GITHUB_ENV` poisoning. [Full reference →](docs/providers/github.md) |
...
└── core/
    ...
    └── checks/
        ...
        ├── github/rules/      # GHA-001 .. GHA-073, GHA-086..121 + TAINT-001..003, TAINT-009
