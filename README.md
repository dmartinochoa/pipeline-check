...
**870+ checks** across **24 providers**, mapped to **15 compliance standards**, with **111 autofixers**, plus **41 attack chains** correlating findings into MITRE ATT&CK-mapped kill chains. A dataflow taint engine catches multi-step and cross-job propagation that single-rule scanners miss.
...
└── core/
    ...
    └── checks/
        ...
        ├── github/rules/      # GHA-001 .. GHA-073, GHA-086..096 + TAINT-001..003
        ...
        ├── npm/rules/         # NPM-001 .. NPM-011 — package.json + package-lock.json + .npmrc supply-chain hygiene + curated compromised-package registry + files-field secret-leak detector + cooldown gate + OSV advisory lookup
