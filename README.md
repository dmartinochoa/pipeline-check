...
| **GitLab CI** | `.gitlab-ci.yml` | `--gitlab-path` | 44 checks · `GL-001..042` + `TAINT-004`/`008` · `CI_JOB_TOKEN` cross-project scope, DinD TLS bypass, debug-trace secret leaks, MR-pipeline IaC apply, mutable `include: component:` |
