...
| GitHub Actions | Yes (95 rules) | Partial | Yes | Partial | No | No |
...
| Package registries (npm / PyPI / Maven / NuGet / Go / Cargo / Composer / RubyGems) | Yes (91 rules across 8 providers) | No | No | No | No | Partial |
| **Analysis depth** | | | | | | |
