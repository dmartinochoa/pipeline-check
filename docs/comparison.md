...
| GitHub Actions | Yes (105 rules) | Partial | Yes | Partial | No | No |
...
| Cross-provider attack chains (MITRE ATT&CK) | Yes (52 chains: 38 AC + 10 XPC + 4 CXPC cross-repo) | No | No | No | No | No |
