...
118 of the 1220+ checks also emit a one-shot patch you can apply with <code>--fix</code>.
</p>
...
<div class="pg-stats__inner">
  ...
  <div class="pg-stat"><div class="pg-stat__num" data-count-to="118">118</div><div class="pg-stat__label">Autofixers</div></div>
</div>
</section>
...
118 of the checks ship a one-shot patch. `--fix` prints a unified diff you can
