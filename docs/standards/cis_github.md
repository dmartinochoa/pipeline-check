...
- **Distinct checks evidencing this standard:** 131
...
| [`1.5.2`](#ctrl-1-5-2) | Ensure scanners are in place to secure CI/CD pipeline instructions | 58 | 11C · 37H · 9M · 1L |
...
**Evidenced by 58 checks** across 6 providers (Argo Workflows, Buildkite, GitHub Actions, GitLab CI, SCM, Tekton).
