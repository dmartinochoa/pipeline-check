...
- **Distinct checks evidencing this standard:** 129
...
| [`1.5.2`](#ctrl-1-5-2) | Ensure scanners are in place to secure CI/CD pipeline instructions | 56 | 11C · 35H · 9M · 1L |
...
**Evidenced by 56 checks** across 6 providers (Argo Workflows, Buildkite, GitHub Actions, GitLab CI, SCM, Tekton).
