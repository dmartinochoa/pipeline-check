...
- **Distinct checks evidencing this standard:** 126
...
| [`1.5.2`](#ctrl-1-5-2) | Ensure scanners are in place to secure CI/CD pipeline instructions | 53 | 11C · 32H · 9M · 1L |
...
**Evidenced by 53 checks** across 6 providers (Argo Workflows, Buildkite, GitHub Actions, GitLab CI, SCM, Tekton).
