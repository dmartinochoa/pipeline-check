...
| [`ESF-D-CODE-REVIEW`](#ctrl-esf-d-code-review) | Require peer review of source and pipeline configuration | 29 | 9H · 12M · 8L |
...
**Evidenced by 29 checks** across 3 providers (AWS, Helm, SCM).
