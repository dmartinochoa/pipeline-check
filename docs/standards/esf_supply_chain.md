...
- **Distinct checks evidencing this standard:** 334
...
| [`ESF-D-SECRETS`](#ctrl-esf-d-secrets) | Protect secrets used during build; no secrets in source or env | 28 | 17C · 9H · 1M · 1L |
...
| [`ESF-D-CODE-REVIEW`](#ctrl-esf-d-code-review) | Require peer review of source and pipeline configuration | 28 | 9H · 12M · 7L |
| [`ESF-D-TOKEN-HYGIENE`](#ctrl-esf-d-token-hygiene) | Use short-lived, federated credentials (OIDC), not long-lived tokens | 14 | 7H · 7M |
| [`ESF-D-INJECTION`](#ctrl-esf-d-injection) | Prevent script / template injection from untrusted pipeline context | 43 | 17C · 19H · 6M · 1L |
| [`ESF-S-VERIFY-DEPS`](#ctrl-esf-s-verify-deps) | Verify third-party and open-source dependencies before use | 67 | 12C · 38H · 14M · 3L |
| [`ESF-S-PIN-DEPS`](#ctrl-esf-s-pin-deps) | Pin dependencies / actions / images to immutable digests | 52 | 1C · 22H · 24M · 5L |
| [`ESF-S-TRUSTED-REG`](#ctrl-esf-s-trusted-reg) | Use only trusted, authenticated package and image registries | 11 | 1C · 6H · 3M · 1L |
...
**Evidenced by 28 checks** across 13 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Jenkins, SCM, Tekton).
...
**Evidenced by 28 checks** across 3 providers (AWS, Helm, SCM).
...
**Evidenced by 14 checks** across 9 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, SCM).
...
**Evidenced by 67 checks** across 14 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Helm, Jenkins, SCM, Tekton).
...
**Evidenced by 11 checks** across 10 providers (AWS, Argo Workflows, Azure DevOps, Buildkite, Cloud Build, Dockerfile, GitLab CI, Helm, SCM, Tekton).
...
**Evidenced by 12 checks** across 12 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, SCM, Tekton).
...
**Evidenced by 14 checks** across 9 providers (AWS, Azure DevOps, Bitbucket, Buildkite, CircleCI, GitHub Actions, GitLab CI, Jenkins, SCM).
...
**Evidenced by 12 checks** across 5 providers (AWS, Argo Workflows, GitHub Actions, SCM, Tekton).
