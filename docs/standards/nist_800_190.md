...
|---------|-------|-------:|--------------|
| [`4.1.1`](#ctrl-4-1-1) | Image vulnerabilities, unpatched CVEs baked into images | 15 | 3H · 12M |
...
**Evidenced by 15 checks** across 12 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Drone CI, GCP, GitHub Actions, GitLab CI, Jenkins).
