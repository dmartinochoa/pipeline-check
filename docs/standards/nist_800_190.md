...
- **Distinct checks evidencing this standard:** 478
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 63 | 17C · 39H · 7M |
...
| [`4.2.1`](#ctrl-4-2-1) | Insecure connections to registries (no TLS / cert validation bypassed) | 44 | 38H · 5M · 1L |
...
**Evidenced by 63 checks** across 14 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
...
**Evidenced by 44 checks** across 23 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, NuGet, OCI manifest, PyPI, RubyGems, Tekton, maven, npm).
