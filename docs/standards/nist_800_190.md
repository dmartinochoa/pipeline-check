...
- **Distinct checks evidencing this standard:** 436
...
| [`4.1.5`](#ctrl-4-1-5) | Use of untrusted images, unpinned tags, unknown provenance | 114 | 2C · 46H · 55M · 11L |
...
**Evidenced by 114 checks** across 22 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
