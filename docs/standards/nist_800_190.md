...
- **Distinct checks evidencing this standard:** 472
...
| [`4.4.3`](#ctrl-4-4-3) | Unbounded network access from containers, egress not restricted | 29 | 4C · 8H · 16M · 1L |
...
**Evidenced by 29 checks** across 11 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Dockerfile, GCP, GitHub Actions, GitLab CI, Jenkins).
