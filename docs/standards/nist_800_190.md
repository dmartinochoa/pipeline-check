...
- **Distinct checks evidencing this standard:** 539
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 95 | 19C · 66H · 10M |
...
**Evidenced by 95 checks** across 16 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Harness CI/CD, Helm, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
