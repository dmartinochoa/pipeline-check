...
- **Distinct checks evidencing this standard:** 530
...
| [`4.1.5`](#ctrl-4-1-5) | Use of untrusted images, unpinned tags, unknown provenance | 127 | 2C · 54H · 58M · 12L · 1I |
...
| [`4.4.5`](#ctrl-4-4-5) | App vulnerabilities, untrusted code paths reached at runtime | 77 | 14C · 45H · 12M · 6L |
...
**Evidenced by 77 checks** across 18 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Harness CI/CD, Jenkins, NuGet, RubyGems, Tekton, npm).
