...
- **Distinct checks evidencing this standard:** 474
...
| [`4.1.2`](#ctrl-4-1-2) | Image configuration defects, privileged flags, insecure runtime settings | 43 | 9C · 17H · 14M · 3L |
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 61 | 17C · 37H · 7M |
| [`4.1.4`](#ctrl-4-1-4) | Embedded clear-text secrets in images | 55 | 23C · 23H · 9M |
| [`4.1.5`](#ctrl-4-1-5) | Use of untrusted images, unpinned tags, unknown provenance | 116 | 2C · 48H · 55M · 11L |
| [`4.2.1`](#ctrl-4-2-1) | Insecure connections to registries (no TLS / cert validation bypassed) | 43 | 37H · 5M · 1L |
...
| [`4.4.3`](#ctrl-4-4-3) | Unbounded network access from containers, egress not restricted | 31 | 4C · 8H · 17M · 2L |
| [`4.4.4`](#ctrl-4-4-4) | Insecure container runtime configurations, privileged flag, host namespace sharing | 37 | 10C · 19H · 7M · 1L |
| [`4.4.5`](#ctrl-4-4-5) | App vulnerabilities, untrusted code paths reached at runtime | 74 | 13C · 43H · 12M · 6L |
...
**Evidenced by 43 checks** across 15 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Jenkins, Kubernetes, OCI manifest, Tekton).
...
**Evidenced by 61 checks** across 14 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
...
**Evidenced by 55 checks** across 18 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, NuGet, Tekton, maven, npm).
...
**Evidenced by 116 checks** across 22 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 43 checks** across 23 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, NuGet, OCI manifest, PyPI, RubyGems, Tekton, maven, npm).
...
**Evidenced by 31 checks** across 11 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Dockerfile, GCP, GitHub Actions, GitLab CI, Jenkins).
...
**Evidenced by 37 checks** across 14 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 74 checks** across 17 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, NuGet, RubyGems, Tekton, npm).
