...
- **Distinct checks evidencing this standard:** 451
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 48 | 17C · 29H · 2M |
...
| [`4.2.1`](#ctrl-4-2-1) | Insecure connections to registries (no TLS / cert validation bypassed) | 40 | 35H · 4M · 1L |
...
| [`4.4.5`](#ctrl-4-4-5) | App vulnerabilities, untrusted code paths reached at runtime | 70 | 13C · 39H · 12M · 6L |
...
**Evidenced by 48 checks** across 12 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, maven, npm).
...
**Evidenced by 40 checks** across 21 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, NuGet, OCI manifest, PyPI, Tekton, maven, npm).
...
**Evidenced by 70 checks** across 15 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, NuGet, Tekton, npm).
