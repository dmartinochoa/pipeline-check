...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 99 | 19C · 70H · 10M |
...
**Evidenced by 99 checks** across 18 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Harness CI/CD, Helm, Jenkins, NuGet, PyPI, RubyGems, Tekton, maven, npm).
