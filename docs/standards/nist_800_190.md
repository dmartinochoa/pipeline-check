...
- **Distinct checks evidencing this standard:** 467
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 60 | 17C · 37H · 6M |
...
| [`4.2.1`](#ctrl-4-2-1) | Insecure connections to registries (no TLS / cert validation bypassed) | 42 | 37H · 4M · 1L |
...
| [`4.4.5`](#ctrl-4-4-5) | App vulnerabilities, untrusted code paths reached at runtime | 72 | 13C · 41H · 12M · 6L |
...
**Evidenced by 60 checks** across 14 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
...
**Evidenced by 42 checks** across 23 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, NuGet, OCI manifest, PyPI, RubyGems, Tekton, maven, npm).
...
**Evidenced by 72 checks** across 17 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, NuGet, RubyGems, Tekton, npm).
