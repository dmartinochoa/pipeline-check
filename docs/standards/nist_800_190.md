...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 89 | 19C · 60H · 10M |
...
**Evidenced by 89 checks** across 16 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Harness CI/CD, Helm, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
