...
- **Distinct checks evidencing this standard:** 493
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 70 | 17C · 43H · 10M |
| [`4.1.4`](#ctrl-4-1-4) | Embedded clear-text secrets in images | 56 | 23C · 24H · 9M |
...
**Evidenced by 70 checks** across 14 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
...
**Evidenced by 56 checks** across 18 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, NuGet, Tekton, maven, npm).
