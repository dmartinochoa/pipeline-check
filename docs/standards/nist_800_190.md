...
- **Distinct checks evidencing this standard:** 537
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 93 | 19C · 64H · 10M |
...
**Evidenced by 93 checks** across 16 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Harness CI/CD, Helm, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
