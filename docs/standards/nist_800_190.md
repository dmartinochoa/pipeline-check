...
- **Distinct checks evidencing this standard:** 446
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 44 | 17C · 26H · 1M |
| [`4.1.4`](#ctrl-4-1-4) | Embedded clear-text secrets in images | 54 | 23C · 22H · 9M |
...
**Evidenced by 44 checks** across 12 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, maven, npm).
...
**Evidenced by 54 checks** across 17 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, Tekton, maven, npm).
