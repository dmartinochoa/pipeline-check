...
- **Distinct checks evidencing this standard:** 529
...
| [`4.1.2`](#ctrl-4-1-2) | Image configuration defects, privileged flags, insecure runtime settings | 45 | 9C · 19H · 14M · 3L |
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 88 | 19C · 59H · 10M |
| [`4.1.4`](#ctrl-4-1-4) | Embedded clear-text secrets in images | 60 | 25C · 26H · 9M |
...
| [`4.4.4`](#ctrl-4-4-4) | Insecure container runtime configurations, privileged flag, host namespace sharing | 39 | 10C · 21H · 7M · 1L |
...
**Evidenced by 39 checks** across 15 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Harness CI/CD, Jenkins, Kubernetes, Tekton).
