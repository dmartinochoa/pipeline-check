...
| [`4.1.2`](#ctrl-4-1-2) | Image configuration defects, privileged flags, insecure runtime settings | 32 | 9C · 14H · 9M |
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 27 | 7C · 20H |
| [`4.1.4`](#ctrl-4-1-4) | Embedded clear-text secrets in images | 28 | 16C · 7H · 5M |
| [`4.1.5`](#ctrl-4-1-5) | Use of untrusted images, unpinned tags, unknown provenance | 53 | 32H · 17M · 4L |
| [`4.2.1`](#ctrl-4-2-1) | Insecure connections to registries (no TLS / cert validation bypassed) | 12 | 10H · 2M |
| [`4.2.2`](#ctrl-4-2-2) | Stale images in registries, drift and unpatched images | 5 | 1H · 2M · 2L |
| [`4.2.3`](#ctrl-4-2-3) | Insufficient authentication and authorization restrictions on registries | 3 | 1C · 1H · 1M |
| [`4.4.3`](#ctrl-4-4-3) | Unbounded network access from containers, egress not restricted | 10 | 1C · 2H · 7M |
| [`4.4.4`](#ctrl-4-4-4) | Insecure container runtime configurations, privileged flag, host namespace sharing | 33 | 10C · 17H · 5M · 1L |
| [`4.4.5`](#ctrl-4-4-5) | App vulnerabilities, untrusted code paths reached at runtime | 17 | 8C · 7H · 2M |
| [`4.4.6`](#ctrl-4-4-6) | Rogue containers, unvetted images executed inside pipeline | 10 | 3H · 6M · 1L |
