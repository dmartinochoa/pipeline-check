...
- **Distinct checks evidencing this standard:** 459
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 54 | 17C · 33H · 4M |
...
| [`4.2.1`](#ctrl-4-2-1) | Insecure connections to registries (no TLS / cert validation bypassed) | 41 | 36H · 4M · 1L |
...
| [`4.4.5`](#ctrl-4-4-5) | App vulnerabilities, untrusted code paths reached at runtime | 71 | 13C · 40H · 12M · 6L |
...
**Evidenced by 54 checks** across 13 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, maven, npm).
...
**Evidenced by 41 checks** across 22 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, NuGet, OCI manifest, PyPI, Tekton, maven, npm).
...
**Evidenced by 71 checks** across 16 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, NuGet, Tekton, npm).
