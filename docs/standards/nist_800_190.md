...
- **Distinct checks evidencing this standard:** 538
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 94 | 19C · 65H · 10M |
...
**Evidenced by 94 checks** across 16 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Harness CI/CD, Helm, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
