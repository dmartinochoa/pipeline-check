...
- **Distinct checks evidencing this standard:** 497
...
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 72 | 17C · 45H · 10M |
| [`4.1.4`](#ctrl-4-1-4) | Embedded clear-text secrets in images | 57 | 23C · 25H · 9M |
...
**Evidenced by 72 checks** across 15 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Composer, GitHub Actions, GitLab CI, Helm, Jenkins, NuGet, PyPI, RubyGems, maven, npm).
...
**Evidenced by 57 checks** across 19 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, Tekton, maven, npm).
