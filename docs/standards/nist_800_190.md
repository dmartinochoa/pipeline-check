...
|---------|-------|-------:|--------------|
| [`4.1.1`](#ctrl-4-1-1) | Image vulnerabilities, unpatched CVEs baked into images | 11 | 1H · 10M |
| [`4.1.2`](#ctrl-4-1-2) | Image configuration defects, privileged flags, insecure runtime settings | 39 | 9C · 16H · 11M · 3L |
| [`4.1.3`](#ctrl-4-1-3) | Embedded malware in images | 41 | 17C · 24H |
| [`4.1.4`](#ctrl-4-1-4) | Embedded clear-text secrets in images | 48 | 23C · 16H · 9M |
| [`4.1.5`](#ctrl-4-1-5) | Use of untrusted images, unpinned tags, unknown provenance | 108 | 2C · 45H · 50M · 11L |
| [`4.2.1`](#ctrl-4-2-1) | Insecure connections to registries (no TLS / cert validation bypassed) | 34 | 29H · 4M · 1L |
| [`4.2.2`](#ctrl-4-2-2) | Stale images in registries, drift and unpatched images | 6 | 1H · 3M · 2L |
| [`4.2.3`](#ctrl-4-2-3) | Insufficient authentication and authorization restrictions on registries | 4 | 2C · 1H · 1M |
| [`4.4.3`](#ctrl-4-4-3) | Unbounded network access from containers, egress not restricted | 14 | 2C · 2H · 10M |
| [`4.4.4`](#ctrl-4-4-4) | Insecure container runtime configurations, privileged flag, host namespace sharing | 36 | 10C · 19H · 6M · 1L |
| [`4.4.5`](#ctrl-4-4-5) | App vulnerabilities, untrusted code paths reached at runtime | 65 | 13C · 36H · 10M · 6L |
...
**Evidenced by 39 checks** across 14 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, OCI manifest, Tekton).
...
**Evidenced by 41 checks** across 12 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, maven, npm).
...
**Evidenced by 48 checks** across 15 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, Tekton, npm).
...
**Evidenced by 108 checks** across 21 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 34 checks** across 19 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, NuGet, OCI manifest, PyPI, Tekton, maven, npm).
...
**Evidenced by 6 checks** across 4 providers (AWS, Cloud Build, Dockerfile, Helm).
...
**Evidenced by 14 checks** across 9 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Jenkins).
...
**Evidenced by 36 checks** across 13 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 65 checks** across 14 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Tekton, npm).
...
**Evidences:** [`4.1.5`](#ctrl-4-1-5) Use of untrusted images, unpinned tags, unknown provenance.
...
**Evidences:** [`4.1.3`](#ctrl-4-1-3) Embedded malware in images.
...
**Evidences:** [`4.1.4`](#ctrl-4-1-4) Embedded clear-text secrets in images.
...
**Evidences:** [`4.4.5`](#ctrl-4-4-5) App vulnerabilities, untrusted code paths reached at runtime.
...
**Evidences:** [`4.4.6`](#ctrl-4-4-6) Rogue containers, unvetted images executed inside pipeline.
...
**Evidences:** [`4.4.3`](#ctrl-4-4-3) Unbounded network access from containers, egress not restricted.
...
**Evidences:** [`4.1.2`](#ctrl-4-1-2) Image configuration defects, privileged flags, insecure runtime settings, [`4.4.4`](#ctrl-4-4-4) Insecure container runtime configurations, privileged flag, host namespace sharing.
...
**Evidences:** [`4.1.1`](#ctrl-4-1-1) Image vulnerabilities, unpatched CVEs baked into images.
...
**Evidences:** [`4.2.1`](#ctrl-4-2-1) Insecure connections to registries (no TLS / cert validation bypassed).
...
**Evidences:** [`4.4.4`](#ctrl-4-4-4) Insecure container runtime configurations, privileged flag, host namespace sharing.
...
**Evidences:** [`4.1.2`](#ctrl-4-1-2) Image configuration defects, privileged flags, insecure runtime settings.
...
**Evidences:** [`4.1.5`](#ctrl-4-1-5) Use of untrusted images, unpinned tags, unknown provenance, [`4.4.6`](#ctrl-4-4-6) Rogue containers, unvetted images executed inside pipeline.
...
**Evidences:** [`4.2.1`](#ctrl-4-2-1) Insecure connections to registries (no TLS / cert validation bypassed), [`4.4.6`](#ctrl-4-4-6) Rogue containers, unvetted images executed inside pipeline.
...
**Evidences:** [`4.2.3`](#ctrl-4-2-3) Insufficient authentication and authorization restrictions on registries.
...
**Evidences:** [`4.1.1`](#ctrl-4-1-1) Image vulnerabilities, unpatched CVEs baked into images, [`4.2.2`](#ctrl-4-2-2) Stale images in registries, drift and unpatched images.
...
**Evidences:** [`4.1.5`](#ctrl-4-1-5) Use of untrusted images, unpinned tags, unknown provenance, [`4.2.1`](#ctrl-4-2-1) Insecure connections to registries (no TLS / cert validation bypassed).
...
**Evidences:** [`4.2.2`](#ctrl-4-2-2) Stale images in registries, drift and unpatched images.
...
**Evidences:** [`4.1.2`](#ctrl-4-1-2) Image configuration defects, privileged flags, insecure runtime settings, [`4.4.3`](#ctrl-4-4-3) Unbounded network access from containers, egress not restricted.
...
**Evidences:** [`4.1.2`](#ctrl-4-1-2) Image configuration defects, privileged flags, insecure runtime settings, [`4.4.5`](#ctrl-4-4-5) App vulnerabilities, untrusted code paths reached at runtime.
...
**Evidences:** [`4.1.5`](#ctrl-4-1-5) Use of untrusted images, unpinned tags, unknown provenance, [`4.2.2`](#ctrl-4-2-2) Stale images in registries, drift and unpatched images.
...
**Evidences:** [`4.1.3`](#ctrl-4-1-3) Embedded malware in images, [`4.1.5`](#ctrl-4-1-5) Use of untrusted images, unpinned tags, unknown provenance.
