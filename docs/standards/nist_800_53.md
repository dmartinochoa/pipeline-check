...
| [`AC-3`](#ctrl-ac-3) | Access Enforcement | 52 | 8C · 27H · 16M · 1L |
| [`AC-6`](#ctrl-ac-6) | Least Privilege | 77 | 11C · 41H · 23M · 2L |
| [`AU-2`](#ctrl-au-2) | Event Logging | 34 | 3H · 5M · 10L · 16I |
| [`AU-9`](#ctrl-au-9) | Protection of Audit Information | 15 | 2C · 9H · 4M |
| [`AU-11`](#ctrl-au-11) | Audit Record Retention | 3 | 3L |
| [`AU-12`](#ctrl-au-12) | Audit Record Generation | 24 | 2H · 3M · 3L · 16I |
| [`CM-2`](#ctrl-cm-2) | Baseline Configuration | 23 | 2H · 16M · 5L |
| [`CM-6`](#ctrl-cm-6) | Configuration Settings | 124 | 14C · 63H · 37M · 10L |
| [`CM-7`](#ctrl-cm-7) | Least Functionality | 42 | 7C · 19H · 15M · 1L |
| [`CM-8`](#ctrl-cm-8) | System Component Inventory | 22 | 1H · 14M · 7L |
| [`IA-5`](#ctrl-ia-5) | Authenticator Management | 85 | 27C · 44H · 13M · 1L |
| [`RA-5`](#ctrl-ra-5) | Vulnerability Monitoring and Scanning | 49 | 16C · 13H · 17M · 3L |
...
| [`SC-7`](#ctrl-sc-7) | Boundary Protection | 29 | 10C · 11H · 8M |
| [`SC-8`](#ctrl-sc-8) | Transmission Confidentiality and Integrity | 27 | 22H · 4M · 1L |
| [`SC-12`](#ctrl-sc-12) | Cryptographic Key Establishment and Management | 9 | 2H · 7M |
| [`SC-13`](#ctrl-sc-13) | Cryptographic Protection | 22 | 14H · 8M |
| [`SC-28`](#ctrl-sc-28) | Protection of Information at Rest | 16 | 6C · 5H · 5M |
| [`SI-2`](#ctrl-si-2) | Flaw Remediation | 68 | 26H · 32M · 10L |
| [`SI-7`](#ctrl-si-7) | Software, Firmware, and Information Integrity | 86 | 11C · 34H · 40M · 1L |
| [`SR-3`](#ctrl-sr-3) | Supply Chain Controls and Processes | 153 | 19C · 74H · 53M · 7L |
| [`SR-4`](#ctrl-sr-4) | Provenance | 55 | 7H · 41M · 7L |
...
**Evidenced by 52 checks** across 11 providers (AWS, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, Kubernetes, SCM).
...
**Evidenced by 77 checks** across 14 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, Jenkins, Kubernetes, SCM, Tekton).
...
**Evidenced by 34 checks** across 9 providers (AWS, Argo Workflows, Buildkite, CircleCI, Cloud Build, Dockerfile, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 15 checks** across 5 providers (AWS, Bitbucket, Cloud Build, GitHub Actions, Jenkins).
...
**Evidenced by 24 checks** across 4 providers (AWS, CircleCI, Cloud Build, Jenkins).
...
**Evidenced by 23 checks** across 14 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Helm, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 124 checks** across 17 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, SCM, Tekton, npm).
...
**Evidenced by 22 checks** across 13 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 85 checks** across 18 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, CloudFormation, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, SCM, Tekton, Terraform, npm).
...
**Evidenced by 49 checks** across 16 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 29 checks** across 10 providers (AWS, Argo Workflows, Cloud Build, CloudFormation, Dockerfile, Drone CI, GitHub Actions, Kubernetes, Tekton, Terraform).
...
**Evidenced by 27 checks** across 19 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, PyPI, SCM, Tekton, maven).
...
**Evidenced by 22 checks** across 12 providers (AWS, Azure DevOps, Bitbucket, Buildkite, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, OCI manifest).
...
**Evidenced by 16 checks** across 8 providers (AWS, Argo Workflows, Buildkite, Dockerfile, GitHub Actions, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 68 checks** across 20 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 86 checks** across 21 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 55 checks** across 15 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Helm, Jenkins, OCI manifest, SCM, Tekton).
