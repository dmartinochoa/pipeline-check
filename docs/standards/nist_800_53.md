...
| [`AC-3`](#ctrl-ac-3) | Access Enforcement | 82 | 12C · 41H · 28M · 1L |
| [`AC-6`](#ctrl-ac-6) | Least Privilege | 86 | 13C · 47H · 24M · 2L |
| [`AU-2`](#ctrl-au-2) | Event Logging | 53 | 7H · 19M · 11L · 16I |
| [`AU-9`](#ctrl-au-9) | Protection of Audit Information | 21 | 2C · 13H · 6M |
| [`AU-11`](#ctrl-au-11) | Audit Record Retention | 7 | 4M · 3L |
| [`AU-12`](#ctrl-au-12) | Audit Record Generation | 34 | 5H · 10M · 3L · 16I |
| [`CM-2`](#ctrl-cm-2) | Baseline Configuration | 25 | 2H · 17M · 6L |
| [`CM-6`](#ctrl-cm-6) | Configuration Settings | 139 | 15C · 66H · 46M · 12L |
| [`CM-7`](#ctrl-cm-7) | Least Functionality | 63 | 7C · 30H · 24M · 2L |
| [`CM-8`](#ctrl-cm-8) | System Component Inventory | 25 | 1H · 16M · 8L |
| [`IA-5`](#ctrl-ia-5) | Authenticator Management | 105 | 27C · 59H · 18M · 1L |
...
| [`SC-8`](#ctrl-sc-8) | Transmission Confidentiality and Integrity | 36 | 28H · 7M · 1L |
| [`SC-12`](#ctrl-sc-12) | Cryptographic Key Establishment and Management | 23 | 7H · 14M · 2L |
| [`SC-13`](#ctrl-sc-13) | Cryptographic Protection | 34 | 22H · 10M · 2L |
| [`SC-28`](#ctrl-sc-28) | Protection of Information at Rest | 25 | 6C · 11H · 8M |
| [`SI-2`](#ctrl-si-2) | Flaw Remediation | 87 | 32H · 43M · 12L |
| [`SI-7`](#ctrl-si-7) | Software, Firmware, and Information Integrity | 93 | 11C · 37H · 44M · 1L |
| [`SR-3`](#ctrl-sr-3) | Supply Chain Controls and Processes | 160 | 19C · 80H · 54M · 7L |
| [`SR-4`](#ctrl-sr-4) | Provenance | 57 | 7H · 43M · 7L |
| [`SR-11`](#ctrl-sr-11) | Component Authenticity | 137 | 11C · 73H · 50M · 3L |
...
**Evidenced by 82 checks** across 16 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GCP, GitHub Actions, GitLab CI, Jenkins, Kubernetes, NuGet, Pulumi, SCM, npm).
...
**Evidenced by 86 checks** across 17 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, Jenkins, Kubernetes, Pulumi, SCM, Tekton).
...
**Evidenced by 53 checks** across 11 providers (AWS, Argo Workflows, Azure Cloud, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 7 checks** across 5 providers (AWS, Azure Cloud, CircleCI, GCP, Jenkins).
...
**Evidenced by 25 checks** across 16 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 139 checks** across 20 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Go modules, Helm, Jenkins, Kubernetes, SCM, Tekton, npm).
...
**Evidenced by 63 checks** across 22 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Go modules, Jenkins, Kubernetes, OCI manifest, Pulumi, PyPI, SCM, Tekton, npm).
...
**Evidenced by 25 checks** across 15 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, GitHub Actions, GitLab CI, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 105 checks** across 23 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, CloudFormation, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Jenkins, Kubernetes, NuGet, Pulumi, PyPI, SCM, Tekton, Terraform, npm).
...
**Evidenced by 36 checks** across 22 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, Pulumi, PyPI, SCM, Tekton, maven).
...
**Evidenced by 23 checks** across 4 providers (AWS, Azure Cloud, GCP, Pulumi).
...
**Evidenced by 34 checks** across 16 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, OCI manifest, Pulumi, PyPI).
...
**Evidenced by 25 checks** across 12 providers (AWS, Argo Workflows, Azure Cloud, Buildkite, Dockerfile, GCP, GitHub Actions, Jenkins, Kubernetes, Pulumi, PyPI, Tekton).
...
**Evidenced by 87 checks** across 24 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Go modules, Helm, Jenkins, Kubernetes, NuGet, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 93 checks** across 25 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Go modules, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 160 checks** across 23 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Go modules, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 137 checks** across 21 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
