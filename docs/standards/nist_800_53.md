...
|---------|-------|-------:|--------------|
| [`AC-2`](#ctrl-ac-2) | Account Management | 20 | 2C · 5H · 13M |
| [`AC-3`](#ctrl-ac-3) | Access Enforcement | 97 | 14C · 54H · 28M · 1L |
| [`AC-6`](#ctrl-ac-6) | Least Privilege | 100 | 14C · 58H · 26M · 2L |
| [`AU-2`](#ctrl-au-2) | Event Logging | 54 | 7H · 20M · 11L · 16I |
| [`AU-9`](#ctrl-au-9) | Protection of Audit Information | 23 | 2C · 15H · 6M |
| [`AU-11`](#ctrl-au-11) | Audit Record Retention | 8 | 4M · 4L |
| [`AU-12`](#ctrl-au-12) | Audit Record Generation | 34 | 5H · 10M · 3L · 16I |
| [`CM-2`](#ctrl-cm-2) | Baseline Configuration | 27 | 2H · 19M · 6L |
| [`CM-6`](#ctrl-cm-6) | Configuration Settings | 186 | 20C · 98H · 52M · 15L · 1I |
| [`CM-7`](#ctrl-cm-7) | Least Functionality | 134 | 8C · 72H · 47M · 7L |
| [`CM-8`](#ctrl-cm-8) | System Component Inventory | 27 | 3H · 16M · 8L |
| [`IA-5`](#ctrl-ia-5) | Authenticator Management | 129 | 30C · 79H · 19M · 1L |
| [`RA-5`](#ctrl-ra-5) | Vulnerability Monitoring and Scanning | 65 | 18C · 17H · 20M · 10L |
| [`SA-10`](#ctrl-sa-10) | Developer Configuration Management | 33 | 3C · 12H · 17M · 1L |
| [`SA-11`](#ctrl-sa-11) | Developer Testing and Evaluation | 118 | 20C · 76H · 16M · 6L |
| [`SA-15`](#ctrl-sa-15) | Development Process, Standards, and Tools | 42 | 4C · 18H · 15M · 5L |
| [`SC-7`](#ctrl-sc-7) | Boundary Protection | 54 | 12C · 25H · 16M · 1L |
| [`SC-8`](#ctrl-sc-8) | Transmission Confidentiality and Integrity | 44 | 34H · 9M · 1L |
| [`SC-12`](#ctrl-sc-12) | Cryptographic Key Establishment and Management | 24 | 7H · 15M · 2L |
| [`SC-13`](#ctrl-sc-13) | Cryptographic Protection | 41 | 28H · 11M · 2L |
| [`SC-28`](#ctrl-sc-28) | Protection of Information at Rest | 36 | 6C · 22H · 8M |
| [`SI-2`](#ctrl-si-2) | Flaw Remediation | 103 | 39H · 51M · 13L |
| [`SI-7`](#ctrl-si-7) | Software, Firmware, and Information Integrity | 122 | 12C · 60H · 48M · 1L · 1I |
| [`SR-3`](#ctrl-sr-3) | Supply Chain Controls and Processes | 228 | 21C · 118H · 74M · 15L |
| [`SR-4`](#ctrl-sr-4) | Provenance | 57 | 7H · 43M · 7L |
| [`SR-11`](#ctrl-sr-11) | Component Authenticity | 165 | 12C · 82H · 60M · 11L |
...
**Evidenced by 97 checks** across 18 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GCP, GitHub Actions, GitLab CI, Harness CI/CD, Jenkins, Kubernetes, NuGet, Pulumi, SCM, Terraform, npm).
...
**Evidenced by 100 checks** across 22 providers (AWS, Actions run history, Argo CD, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Developer environment, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab pipeline run history, Harness CI/CD, Jenkins, Kubernetes, Pulumi, SCM, Tekton).
...
**Evidenced by 54 checks** across 12 providers (AWS, Argo CD, Argo Workflows, Azure Cloud, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 23 checks** across 10 providers (AWS, Azure DevOps, Bitbucket, CircleCI, Cloud Build, GCP, GitHub Actions, GitLab CI, Jenkins, Pulumi).
...
**Evidenced by 27 checks** across 16 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 186 checks** across 27 providers (AWS, Actions run history, Argo CD, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, GitLab pipeline run history, Go modules, Harness CI/CD, Helm, Jenkins, Kubernetes, NuGet, Pulumi, SCM, Tekton, npm).
...
**Evidenced by 134 checks** across 30 providers (AWS, Argo CD, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Composer, Developer environment, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Go modules, Harness CI/CD, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, Pulumi, PyPI, RubyGems, SCM, Tekton, maven, npm).
...
**Evidenced by 27 checks** across 17 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, GCP, GitHub Actions, GitLab CI, Jenkins, OCI manifest, RubyGems, Tekton).
...
**Evidenced by 65 checks** across 19 providers (AWS, Actions run history, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GCP, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 33 checks** across 10 providers (AWS, Azure DevOps, Bitbucket, Buildkite, CircleCI, GitHub Actions, GitLab CI, Harness CI/CD, Jenkins, SCM).
...
**Evidenced by 118 checks** across 17 providers (AWS, Actions run history, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, GitLab pipeline run history, Harness CI/CD, Jenkins, SCM, Tekton).
...
**Evidenced by 42 checks** across 9 providers (AWS, Azure DevOps, Bitbucket, CircleCI, GitHub Actions, GitLab CI, Harness CI/CD, Jenkins, SCM).
...
**Evidenced by 54 checks** across 14 providers (AWS, Actions run history, Argo Workflows, Azure Cloud, Cloud Build, CloudFormation, Dockerfile, Drone CI, GCP, GitHub Actions, Harness CI/CD, Kubernetes, Tekton, Terraform).
...
**Evidenced by 44 checks** across 25 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Harness CI/CD, Helm, Jenkins, Kubernetes, NuGet, Pulumi, PyPI, RubyGems, SCM, Tekton, maven).
...
**Evidenced by 103 checks** across 28 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Go modules, Harness CI/CD, Helm, Jenkins, Kubernetes, Modelfile, NuGet, PyPI, RubyGems, SCM, Tekton, maven, npm).
...
**Evidenced by 57 checks** across 16 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Helm, Jenkins, OCI manifest, SCM, Tekton).
...
**Evidenced by 165 checks** across 24 providers (AWS, Actions run history, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Harness CI/CD, Helm, Jenkins, Kubernetes, Modelfile, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
