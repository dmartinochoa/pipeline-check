...
|---------|-------|-------:|--------------|
| [`AC-2`](#ctrl-ac-2) | Account Management | 10 | 1C · 3H · 6M |
| [`AC-3`](#ctrl-ac-3) | Access Enforcement | 62 | 10C · 33H · 18M · 1L |
| [`AC-6`](#ctrl-ac-6) | Least Privilege | 81 | 13C · 43H · 23M · 2L |
| [`AU-2`](#ctrl-au-2) | Event Logging | 38 | 5H · 7M · 10L · 16I |
| [`AU-9`](#ctrl-au-9) | Protection of Audit Information | 16 | 2C · 9H · 5M |
| [`AU-11`](#ctrl-au-11) | Audit Record Retention | 5 | 2M · 3L |
| [`AU-12`](#ctrl-au-12) | Audit Record Generation | 27 | 4H · 4M · 3L · 16I |
| [`CM-2`](#ctrl-cm-2) | Baseline Configuration | 24 | 2H · 17M · 5L |
| [`CM-6`](#ctrl-cm-6) | Configuration Settings | 128 | 14C · 65H · 39M · 10L |
| [`CM-7`](#ctrl-cm-7) | Least Functionality | 42 | 7C · 19H · 15M · 1L |
| [`CM-8`](#ctrl-cm-8) | System Component Inventory | 23 | 1H · 15M · 7L |
| [`IA-5`](#ctrl-ia-5) | Authenticator Management | 89 | 27C · 48H · 13M · 1L |
| [`RA-5`](#ctrl-ra-5) | Vulnerability Monitoring and Scanning | 50 | 16C · 14H · 17M · 3L |
...
| [`SC-7`](#ctrl-sc-7) | Boundary Protection | 34 | 10C · 15H · 9M |
| [`SC-8`](#ctrl-sc-8) | Transmission Confidentiality and Integrity | 28 | 23H · 4M · 1L |
| [`SC-12`](#ctrl-sc-12) | Cryptographic Key Establishment and Management | 13 | 3H · 9M · 1L |
| [`SC-13`](#ctrl-sc-13) | Cryptographic Protection | 26 | 15H · 10M · 1L |
| [`SC-28`](#ctrl-sc-28) | Protection of Information at Rest | 19 | 6C · 7H · 6M |
| [`SI-2`](#ctrl-si-2) | Flaw Remediation | 70 | 27H · 33M · 10L |
| [`SI-7`](#ctrl-si-7) | Software, Firmware, and Information Integrity | 88 | 11C · 34H · 42M · 1L |
...
**Evidenced by 10 checks** across 6 providers (AWS, Argo Workflows, Azure Cloud, Kubernetes, SCM, Tekton).
...
**Evidenced by 62 checks** across 13 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GCP, GitHub Actions, GitLab CI, Jenkins, Kubernetes, SCM).
...
**Evidenced by 81 checks** across 16 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, Jenkins, Kubernetes, SCM, Tekton).
...
**Evidenced by 38 checks** across 11 providers (AWS, Argo Workflows, Azure Cloud, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 5 checks** across 5 providers (AWS, Azure Cloud, CircleCI, GCP, Jenkins).
...
**Evidenced by 27 checks** across 6 providers (AWS, Azure Cloud, CircleCI, Cloud Build, GCP, Jenkins).
...
**Evidenced by 24 checks** across 15 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 128 checks** across 19 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, SCM, Tekton, npm).
...
**Evidenced by 42 checks** across 16 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Kubernetes, OCI manifest, SCM, Tekton, npm).
...
**Evidenced by 23 checks** across 14 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GCP, GitHub Actions, GitLab CI, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 89 checks** across 20 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, CloudFormation, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Jenkins, Kubernetes, SCM, Tekton, Terraform, npm).
...
**Evidenced by 50 checks** across 17 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GCP, GitHub Actions, GitLab CI, Jenkins, NuGet, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 34 checks** across 12 providers (AWS, Argo Workflows, Azure Cloud, Cloud Build, CloudFormation, Dockerfile, Drone CI, GCP, GitHub Actions, Kubernetes, Tekton, Terraform).
...
**Evidenced by 28 checks** across 20 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, PyPI, SCM, Tekton, maven).
...
**Evidenced by 13 checks** across 3 providers (AWS, Azure Cloud, GCP).
...
**Evidenced by 26 checks** across 14 providers (AWS, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, OCI manifest).
...
**Evidenced by 19 checks** across 9 providers (AWS, Argo Workflows, Azure Cloud, Buildkite, Dockerfile, GitHub Actions, Jenkins, Kubernetes, Tekton).
...
**Evidenced by 70 checks** across 22 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, PyPI, SCM, Tekton, maven, npm).
...
**Evidenced by 88 checks** across 23 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, SCM, Tekton, maven, npm).
