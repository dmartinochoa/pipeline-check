...
| [`CM-7`](#ctrl-cm-7) | Least Functionality | 130 | 8C · 69H · 46M · 7L |
...
| [`SR-3`](#ctrl-sr-3) | Supply Chain Controls and Processes | 214 | 19C · 114H · 67M · 14L |
...
**Evidenced by 214 checks** across 26 providers (AWS, Argo CD, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Cloud Build, Composer, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Go modules, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, PyPI, RubyGems, SCM, Tekton, maven, npm).
