...
- **Distinct checks evidencing this standard:** 427
...
|---------|-------|-------:|--------------|
| [`Branch-Protection`](#ctrl-branch-protection) | Default branch is protected against force-push, deletion, and direct push without review | 22 | 7H · 9M · 6L |
| [`Code-Review`](#ctrl-code-review) | Changes merged to the default branch require review | 31 | 12H · 18M · 1L |
| [`Dangerous-Workflow`](#ctrl-dangerous-workflow) | No dangerous patterns in CI workflows (untrusted checkout, script injection) | 133 | 30C · 83H · 18M · 2L |
...
| [`Pinned-Dependencies`](#ctrl-pinned-dependencies) | Dependencies (actions, images, includes, packages) are pinned to immutable references from trusted sources | 96 | 3C · 55H · 33M · 5L |
...
| [`Signed-Releases`](#ctrl-signed-releases) | Release artifacts are cryptographically signed | 32 | 6H · 25M · 1L |
| [`Token-Permissions`](#ctrl-token-permissions) | CI tokens are scoped to the minimum required permissions | 89 | 29C · 37H · 23M |
| [`Vulnerabilities`](#ctrl-vulnerabilities) | Project scans for and resolves known vulnerabilities | 14 | 1C · 1H · 12M |
...
**Evidenced by 22 checks** across SCM.
...
**Evidenced by 31 checks** across 9 providers (AWS, Azure DevOps, Bitbucket, Buildkite, CircleCI, GitHub Actions, GitLab CI, Jenkins, SCM).
...
**Evidenced by 133 checks** across 13 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, Tekton).
...
**Evidenced by 96 checks** across 17 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Helm, Jenkins, OCI manifest, SCM, Tekton, maven).
...
**Evidenced by 17 checks** across 12 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, SCM, Tekton).
...
**Evidenced by 23 checks** across 12 providers (Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, Dockerfile, GitHub Actions, GitLab CI, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 32 checks** across 12 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, OCI manifest, Tekton).
...
**Evidenced by 89 checks** across 16 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, CloudFormation, Dockerfile, Drone CI, GitHub Actions, GitLab CI, Jenkins, SCM, Tekton, Terraform).
...
**Evidenced by 14 checks** across 13 providers (AWS, Argo Workflows, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, GitHub Actions, GitLab CI, Jenkins, SCM, Tekton, maven).
...
**Evidences:** [`Pinned-Dependencies`](#ctrl-pinned-dependencies) Dependencies (actions, images, includes, packages) are pinned to immutable references from trusted sources, [`SBOM`](#ctrl-sbom) Releases publish a software bill of materials.
...
**Evidences:** [`Pinned-Dependencies`](#ctrl-pinned-dependencies) Dependencies (actions, images, includes, packages) are pinned to immutable references from trusted sources, [`Signed-Releases`](#ctrl-signed-releases) Release artifacts are cryptographically signed.
...
**Evidences:** [`Code-Review`](#ctrl-code-review) Changes merged to the default branch require review, [`Token-Permissions`](#ctrl-token-permissions) CI tokens are scoped to the minimum required permissions.
...
**Evidences:** [`Dangerous-Workflow`](#ctrl-dangerous-workflow) No dangerous patterns in CI workflows (untrusted checkout, script injection), [`Token-Permissions`](#ctrl-token-permissions) CI tokens are scoped to the minimum required permissions.
...
**Evidences:** [`Pinned-Dependencies`](#ctrl-pinned-dependencies) Dependencies (actions, images, includes, packages) are pinned to immutable references from trusted sources, [`Vulnerabilities`](#ctrl-vulnerabilities) Project scans for and resolves known vulnerabilities.
