...
| [`6.5.1`](#ctrl-6-5-1) | Changes to system components follow secure development procedures | 347 | 51C · 153H · 114M · 28L · 1I |
...
**Evidenced by 347 checks** across 28 providers (AWS, Argo CD, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, Cargo, CircleCI, Cloud Build, Developer environment, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Go modules, Helm, Jenkins, Kubernetes, NuGet, OCI manifest, Pulumi, PyPI, SCM, Tekton, maven, npm).
