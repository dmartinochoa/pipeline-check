...
- **Distinct checks evidencing this standard:** 806
...
| [`8.2.1`](#ctrl-8-2-1) | Strong unique identifiers are assigned to each user and service account | 122 | 26C · 68H · 26M · 2L |
...
**Evidenced by 122 checks** across 27 providers (AWS, Argo Workflows, Azure Cloud, Azure DevOps, Bitbucket, Buildkite, CircleCI, Cloud Build, CloudFormation, Composer, Dockerfile, Drone CI, GCP, GitHub Actions, GitLab CI, Helm, Jenkins, Kubernetes, NuGet, Pulumi, PyPI, RubyGems, SCM, Tekton, Terraform, maven, npm).
