...
RULE = Rule(
    ...
    docs_note=(
        "Complements CC-021 (missing lockfile flag). Git URL installs "
    ...
    exploit_example=(
        ...
        "# build with its context secrets. `file:` paths and bare\n"
        "# tarball URLs share the hole.\n"
        "\n"
...
def check(path: str, doc: dict[str, Any]) -> Finding:
    ...
    desc = (
        "No integrity-bypassing package installs detected in this config."
        if passed else
