...
RULE = Rule(
    ...
    docs_note=(
        ...
        "policies\": true}`` passes. (Custom policies with zero "
        "patterns block every branch, so the boolean flag alone is "
        "a safe pass.) Passes silently when no environments "
