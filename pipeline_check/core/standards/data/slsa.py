...
STANDARD = Standard(
    ...
    mappings={
        ...
        "SCM-006":  ["Build.L2.Signed"],                           # signed commits (source-side root of provenance)
        "SCM-007":  ["Build.L3.NonFalsifiable"],                   # force-push allowed (history rewrite undermines provenance)
        "SCM-009":  ["Build.L3.NonFalsifiable"],                   # branch deletions allowed (provenance lineage erased)
        "SCM-022":  ["Build.L3.Isolated",
                     "Build.L3.NonFalsifiable"],                   # allowed_actions unrestricted (untrusted 3rd-party in build env)
        "SCM-029":  ["Build.L3.NonFalsifiable"],                   # ruleset not enforced (governance silently disabled)
        "SCM-030":  ["Build.L3.NonFalsifiable"],                   # ruleset always-bypass (governance bypassed without audit)
